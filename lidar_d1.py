...
def pointcloud_updater():
    global start_time_ns, gotnp, i_max_points, frame_count, dframe_count
    while True:
        ...
        if len(data_list) >= i_max_points:
            ...
            for i, point in enumerate(points):
                ...
                print(f"{current_time}, {elapsed_s:.3f}s, {vert_angle},{azimuth:.2f},{distance:.2f},Points:{len(data_list)}, {frequency:.2f} kHz, {dfrequency:.2f} Hz")
