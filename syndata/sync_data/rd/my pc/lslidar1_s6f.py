    ...
    while True:
        ...
        if len(data_list) >= i_max_points:
            ...
            for vert_angle, azimuth, distance, intensity in data_list:
                ...
                # print(f"{current_time}, {elapsed_s_total:.3f}s, {vert_angle}, {azimuth:.2f}, {distance:.2f}, {ax}, {ay}, {az}, {tem}°C, Points:{len(data_list)}, {frequency:.2f} kHz, {dfrequency:.2f} Hz")
                if elapsed_s_total > printclock:
                    printclock = printclock + 0.1
                    ...
                    log_line = f"{current_time},{elapsed_s_total:.3f},{vert_angle},{azimuth:.2f},{distance:.2f},{board2_temp:.2f},{ax},{ay},{az},{tem},{len(data_list)},{frequency:.2f},{dfrequency:.2f}"
