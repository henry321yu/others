...
byte charget = 88; //充電次數
long circletime = 500; // verson.1 was 150 + 50
long chargecircletime = 5; //ondelay+offdelay
long a1ondelay = 0, a1offdelay = 0;
long a2time = 440, a3time = 48, a2stop = 2; //a3time must<(circletime-a2time) or will break the circletime
long a4time = 4, delaytime = 2000, initializetime = 500; //new 2 channel big C's relay for Vinb
...
void sync() {
  ...
  if (test == 1) {
    ...
    currentmillis = micros() - headmillis;
    resettime = 30000000 + currentmillis;
  }
