...
int ID;
long values[10], t[12];
double x, y, z, xm[12], ym[12], zm[12], gx1, gy1, gz1, time, f, tm[12], at; //, x1, y1, z1
...
void loop() {
  ...
  magdata = String(xm[4], 5) + ", " + String(ym[5], 5) + ", " + String(zm[6], 5);
  mag2data = String(xm[8], 5) + ", " + String(ym[9], 5) + ", " + String(zm[10], 5);
  tmdata = String(tm[7], 2) + ", " + String(tm[11], 2) + ", " + String(at, 2);
...
void mag_data() {
  ...
  tm[3] = readRegister(MMC5883MA_TEMPERATURE);
  ...
  ym[1] = (ym[1] - 0x8000) / 40.96;
  zm[2] = (zm[2] - 0x8000) / 40.96;
