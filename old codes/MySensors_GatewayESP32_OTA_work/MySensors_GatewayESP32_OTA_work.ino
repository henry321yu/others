...
//#define MY_RF24_CE_PIN (4) // CE Если будешь двигать , иначе по дефолту


#define MY_WIFI_SSID "****" // Имя и пароль
...
#define MY_IP_ADDRESS 192,168,1,35 // Подставь свою сеть

// If using static ip you can define Gateway and Subnet address as well
#define MY_IP_GATEWAY_ADDRESS 192,168,1,1 // И гетвей то же
...
#define MY_DEFAULT_ERR_LED_PIN 02  // Transfer data error led pin
#define MY_DEFAULT_RX_LED_PIN  02  // Receive Data led pin
#define MY_DEFAULT_TX_LED_PIN  02 // Transmit Data led pin
...
void presentation()
{
  ...
  sendSketchInfo("GateWay Node_32_OTA", "2.0");
}
