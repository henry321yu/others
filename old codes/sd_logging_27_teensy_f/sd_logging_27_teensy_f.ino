...
const int led = 5; //
int ID, mn[6] = {2, 3, 4, 5, 6, 7};
long values[10], t[12];
double x[3], y[3], z[3], xm[7], ym[7], zm[7], gx1, gy1, gz1, time, f, tm[7], ta[3], tg; //, x1, y1, z1
String logFileName, accdata, gyrdata, magdata, logdata, mag2data, tmdata, Rotordata;
File logFile;
unsigned long i = 0, t0;//,t1,t2,t3,t4,t5,t6,t7,t8;
const int rinA = 1, rinB = 2;
...
void loop() {
  ...
  logdata = String(time, 3) + ", " + accdata + ", " + gyrdata + ", " + magdata + ", " + mag2data + ", " + Rotordata + ", " + tmdata;
  //logdata = String(time, 3) + ", " + gyrdata;
  ...
  /*t8 = micros();
    ...
    Serial.print("\t");Serial.print("mpu");
    Serial.print("\t");Serial.print(t4);
    Serial.print("\t");Serial.print("rotor");
    Serial.print("\t");Serial.print(t5);
    Serial.print("\t");Serial.print("string");
    Serial.print("\t");Serial.print(t6);
    Serial.print("\t");Serial.print("sd");
    Serial.print("\t");Serial.print(t7);
    Serial.print("\t");Serial.print("timr");
    Serial.print("\t");Serial.print(t8);
