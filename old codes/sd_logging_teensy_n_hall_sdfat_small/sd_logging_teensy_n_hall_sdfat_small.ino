...
const int H1 = A8, H2 = A9; //hall need wire //H1 = 2, H2 = 3; //wired
...
//    error("sd begin failed");
  ...
  for (int j = 0; j < 2; j++) {
    ...
    delay(30);
    writeRegister(mag_I2c , MMC5883MA_INTERNAL_CONTROL_1, 0x02); //3 600hz
    delay(30);
  }
...
void loop() {
  ...
  //delayMicroseconds(10); //nan teensy 4.0 400hz//430  teensy 4.0 400hz//205(150(all data)) teensy 4.1 400hz(all data) //7500 teensy 4.1 100hz(remember change M set,beeper,timer)
