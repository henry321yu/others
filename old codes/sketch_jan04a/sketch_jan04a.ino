...
#define outputA 20 //定義 outputA = 6
#define outputB 21 //定義 outputB = 7
...
//初始化設定↓↓↓
void setup() { 
pinMode (outputA,INPUT_PULLUP); //埠口模式設定：outputA 設為 輸入
pinMode (outputB,INPUT_PULLUP); //埠口模式設定：outputB 設為 輸入
