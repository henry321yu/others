...
int CS=10;
char Power = 0x2D;//1 for standby, 0 for go
char Range = 0x2C;// for range

//This is a list of some of the registers available on the ADXL345.
//To learn more about these and the rest of the registers on the ADXL345, read the datasheet!
char POWER_CTL = 0x2D;  //Power Control Register
char DATA_FORMAT = 0x31;
char DATAX0 = 0x09; //X-Axis Data 0
char DATAX1 = 0x08; //X-Axis Data 1
char DATAY0 = 0x0B; //Y-Axis Data 0
char DATAY1 = 0x0A; //Y-Axis Data 1
char DATAZ0 = 0x0D; //Z-Axis Data 0
char DATAZ1 = 0x0C; //Z-Axis Data 1
