...
int ID;
long values[10], t[12];
double x[3], y[3], z[3], xm[7], ym[7], zm[7], gx1, gy1, gz1, time, f, tm[7], at[3]; //, x1, y1, z1
...
void loop() {
  ...
  tmdata = String(tm[1], 2) + ", " + String(tm[2], 2) + ", " + String(tm[3], 2) + ", " + String(tm[4], 2) + ", " + String(tm[5], 2) + ", " + String(tm[6], 2) + ", " + String(at[1], 2) + ", " + String(at[2], 2);
