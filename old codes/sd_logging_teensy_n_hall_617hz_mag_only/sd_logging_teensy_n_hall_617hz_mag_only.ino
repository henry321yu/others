...
void setup() {
  ...
  for (int j = 0; j < 2; j++) {
    ...
    delay(30);
    writeRegister(mag_I2c , MMC5883MA_INTERNAL_CONTROL_1, 0x03); //0 100hz 3 600hz
    delay(30);
  }
...
void loop() {
  ...
  //logdata = String(time, 3) + ", " + accdata + ", " + gyrdata + ", " + magdata + ", " + mag2data + ", " + halldata + ", " + tmdata + ", " +  String(f, 2);
  logdata = String(tt, 3) + ", " + magdata + ", " + tmdata + ", " +  String(f, 2);
  ...
  //delayMicroseconds(3750); //3750 256hz 1mag
  //delayMicroseconds(4000); //4000 256hz 1mag new sd//4400 256Mhz 2mag//5400 256Mhz 1mag //360 6mag 100hz
