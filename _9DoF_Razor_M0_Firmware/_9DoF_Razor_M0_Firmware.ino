...
void logIMUData(void)
{
  ...
  if (enableAccel) // If accelerometer logging is enabled
  {
    ...
    {
      imuLog += String(imu.calcAccel(imu.ax),6) + ", ";
      imuLog += String(imu.calcAccel(imu.ay),6) + ", ";
      imuLog += String(imu.calcAccel(imu.az),6) + ", ";
    }
    else
    {
      imuLog += String(imu.ax,6) + ", ";
      imuLog += String(imu.ay,6) + ", ";
      imuLog += String(imu.az,6) + ", ";
    }
  }
